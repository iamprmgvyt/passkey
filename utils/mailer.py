...
TRANSLATIONS = {
    "vi": {
        ...
        "expiry_notice": "⏱️ Mã này có hiệu lực trong vòng <strong>10 phút</strong>. Vì sự an toàn, tuyệt đối không chia sẻ mã này cho người khác.",
    ...
    "en": {
        ...
        "expiry_notice": "⏱️ This code will expire in <strong>10 minutes</strong>. For your security, never share this code with anyone.",
    ...
    "ja": {
        ...
        "expiry_notice": "⏱️ このコードの有効期限は <strong>10分間</strong> です。セキュリティ保護のため、第三者と共有しないでください。",
    ...
    "ko": {
        ...
        "expiry_notice": "⏱️ 이 코드는 <strong>10분</strong> 동안 유효합니다. 보안을 위해 타인과 공유하지 마세요.",
    ...
    "zh": {
        ...
        "expiry_notice": "⏱️ 此验证码有效期为 <strong>10分钟</strong>。为了您的账号安全，切勿向他人透露此代码。",
    ...
    "es": {
        ...
        "expiry_notice": "⏱️ Este código caducará en <strong>10 minutos</strong>. Por tu seguridad, nunca compartas este código con nadie.",
    ...
    "fr": {
        ...
        "expiry_notice": "⏱️ Ce code expirera dans <strong>10 minutes</strong>. Pour votre sécurité, ne partagez jamais ce code.",
    ...
    "de": {
        ...
        "expiry_notice": "⏱️ Dieser Code läuft in <strong>10 Minuten</strong> ab. Teile diesen Code aus Sicherheitsgründen mit niemandem.",
    ...
    "ru": {
        ...
        "expiry_notice": "⏱️ Этот код действителен в течение <strong>10 минут</strong>. В целях безопасности никогда не передавайте его третьим лицам.",
    ...
    "pt": {
        ...
        "expiry_notice": "⏱️ Este código expira em <strong>10 minutos</strong>. Para sua segurança, nunca compartilhe este código.",
